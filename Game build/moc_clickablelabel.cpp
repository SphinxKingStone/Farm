...
QT_MOC_LITERAL(4, 37, 13), // "doubleClicked"
QT_MOC_LITERAL(5, 51, 7), // "entered"
QT_MOC_LITERAL(6, 59, 4) // "left"

    },
    "ClickableLabel\0clicked\0\0rightClicked\0"
    "doubleClicked\0entered\0left"
};
...
void ClickableLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ClickableLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClickableLabel::rightClicked)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            typedef void (ClickableLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClickableLabel::entered)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (ClickableLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClickableLabel::left)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 3
void ClickableLabel::entered()
{
    QMetaObject::activate(this, &staticMetaObject, 3, Q_NULLPTR);
}

// SIGNAL 4
void ClickableLabel::left()
{

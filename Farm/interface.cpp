...
Interface::Interface(QWidget *parent)
{
    ...
    scene->setBackgroundBrush(QBrush(QImage(QCoreApplication::applicationFilePath().left(QCoreApplication::applicationFilePath().length() - 8) + "res/green_bg.jpg")));
...
void Interface::draw_players_cells()
{
    ...
    label->setPixmap(QPixmap(QCoreApplication::applicationFilePath().left(QCoreApplication::applicationFilePath().length() - 8) + "res/square.png").scaled(45,45,Qt::KeepAspectRatio));
